                            ...
                            <div class="row">
                                <div class="col-md-12 jenis-data">
                                  <form action="" method="post">
                                      <select name="buat_baru" id="">
                                          <option value="">Buat Baru</option>
                                          <option value="">Buat Baru</option>
                                          <option value="">Buat Baru</option>
                                      </select>
                                      <br>
                                      <input type="text" name="berat_badan" placeholder="Berat Badan">
                                      <input type="text" name="berat_badan" placeholder="Tinggi Badan">
                                      <br> 
                                  </form>
                                   <button name="submit" id="submit" style="width:100px;" onclick="pages(1);">
                                          Konfirmasi
                                    </button>
                                </div>
                            </div>
                        </div>
                        <div id="4" style="display:none; position: relative;">
                           <div class="row">
                                <div class="col-md-3 title-box">
                                    <h2>
                                         <img src="../../assets/ico/button_back.png" width="50px" alt="" onclick="pages(-1);">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <br>
                                    <img src="" alt="ini gambar" width="50px;">
                                    <button id="submit" style="width: 200px;" onclick="pages(1);toHome();">
                                        Konfirmasi
                                    </button>
                                </div>
                            </div>
                        </div>
                        <div id="5" style="display:none; position: relative;">
                            <div class="row">
                                <div class="col-md-3 title-box">
                                    <h2>
                                    <img src="../../assets/ico/button_back.png" width="50px" alt="" onclick="pages(-1);">
                                ...
                                <div class="col-md-9 ">
                                    <img class="pict" style="margin-left:200px;" width="300px" src="../../assets/ico/nfc.png" alt="">
                                    <h2 style="margin-left:200px;"><b>Proses Penambahan Berhasil</b></h2>
                                    <p style="margin-left:200px;">Kami akan mengalihkan ke beranda dalam beberapa detik</p>
                                </div>
                            </div>
                        </div>
